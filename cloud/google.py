"""Google Drive adapter placeholder with a safe explicit failure."""
...
class GoogleCloud(DriveCloud):
    ...
    def _unavailable(self):
        raise CloudNotConfigured(
            "Google Drive adapter is not configured in the MVP; "
            "provide OAuth credentials and explicit --apply integration"
        )
